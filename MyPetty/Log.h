 ...
 *8.私信会出现接收到1条消息，但是显示0条新消息。
 ...
 2015.04.14
 1.没有宠物的弹框。
 2.精选和关注列表，两张照片之间没有横线，而是一段空隙（参考效果图）。
 3.文章的分享新浪微博。
 4.个人中心我的萌星顺序按官衔排。
 5.精选点某条评论回复，点查看全部跳详情页反面。
 6.每次进入海选界面重新下载数据。
 7.海选界面改成列表形式，collectionView中嵌套一个collectionView。
 
 2015.04.15
 1.投票页面修改。
 2.活动排名列表。
 3.推荐页面的2个动画，API，分享，没金币和花费金币的提示框等的完善。
 
 
 2015.04.16
 1.没有加入别的圈子进个人中心闪退。
 2.自己发的照片在精选页面不能回复别人评论。
 3.新投票贡献卡片界面。
 4.精选添加不能回复自己的浮框。
 5.投票提示设置。
 6.参赛按钮的功能，发照片发布页修改，发布后的弹框及弹框分享的修改。
 7.和某人聊天，对话为空的自动删除。
 8.2个启动图的替换。
 ...
 8.个人中心的充值用开关控制。
 9.引导图，4s的引导图适配。
 10.底部按钮动画，信息数量角标位置，顶部选择栏颜色透明度，更多按钮文字去掉，位置调整。
 
 
 2015.04.20
 1.底部按钮图标调整。
 2.个人中心细节微调。
 3.商城礼物服务器控制，涉及界面：商城，背包，宠物主页动态(送礼和捣乱)，收到礼物；摇一摇，献爱心弹框。
 
 
 2015.04.21
 1.个人中心点击刷新宠物列表。
 2.loading效果修改。
 3.探索选择框颜色修改，文章上拉无更多提示，故事头图等比缩放，文章文字顶部对齐。
 4.loading。
 5.推送证书。
 
 
 2015.04.22
 1.新底部tabBar按钮及若干页面滑动列表高度调整.
 2.新loading。
 3.滑动瀑布流底部动态出现消失。
 4.照片详情背面及评论，精选和关注的评论，发布照片时候的自定义表情。
 5.自己宠物变成拉粉丝，点击弹出分享。
 6.分享文字修改。
 7.个人中心刷新。
 8.私信点箭头进详情页背面第三列。
