...
-(UIView *)createOtherViewAtIndex:(NSInteger)index
{
    ...
    UILabel *titleLabel = [MyControl createLabelWithFrame:CGRectMake(5, timeLabel.frame.origin.y+timeLabel.frame.size.height, view.frame.size.width-5, 20) Font:15 Text:@""];
