...
//                playView.isFromBanner = YES;
                ...
                rect.size.height = self.view.frame.size.height-32-(h+8);
...
//    if (!hasBanner) {
        ...
        qtmquitView.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height);
...
-(void)adjustRandomBigWithTop
{
    //    if (!hasBanner) {
    [UIView beginAnimations:nil context:nil];
    qtmquitView.frame = CGRectMake(0, -38, self.view.frame.size.width, self.view.frame.size.height);
    [UIView commitAnimations];
    //    }else{
    //
    //    }
...
//    CGFloat bottomHeight = spe*99/128-10;
        [UIView beginAnimations:nil context:nil];
        qtmquitView.frame = CGRectMake(0, 32, self.view.frame.size.width, self.view.frame.size.height-32);
        [UIView commitAnimations];
//    }else{
//        [UIView beginAnimations:nil context:nil];
...
-(void)createQtmquitView
{
    ...
    qtmquitView = [[TMQuiltView alloc] initWithFrame:CGRectMake(0, 32, self.view.frame.size.width, self.view.frame.size.height-32)];
...
//    }
    //瀑布流页title显示表情
    cell.titleLabel.attributedText = [ControllerManager changToAttributedText:model.cmt];
...
{
//    CGFloat thisEndOffsetY = scrollView.contentOffset.y;
//    if (beginOffsetY<thisEndOffsetY) {
//        if (lastOffSetY < thisEndOffsetY) {
//            self.rollStop();
//        }
//        [self showBanner];
//    }
    ...
    if (scrollView.contentOffset.y == 0) {
        [self showBanner];
        [UIView beginAnimations:nil context:nil];
        qtmquitView.frame = CGRectMake(0, 64+playView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height-64-playView.frame.size.height);
        [UIView commitAnimations];
    }
}
