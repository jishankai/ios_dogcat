...
+ (NSArray *)defaultEmotions
{
    ...
    if (!_defaultEmotions) {
        ...
        [_defaultEmotions makeObjectsPerformSelector:@selector(setDirectory:) withObject:@"EmotionIcons/lxh"];
    }
...
{
    if (!_emojiEmotions) {
        NSString *plist = [[NSBundle mainBundle] pathForResource:@"EmotionIcons/emoji/emoji-info" ofType:@"plist"];
