...
-(void)createUI
{
    ...
    UILabel * title = [MyControl createLabelWithFrame:CGRectMake(100, 190-64, 120, 20) Font:17 Text:@"我是大萌星"];
...
//    wechat.showsTouchWhenHighlighted = YES;
    ...
    UIButton * permit = [MyControl createButtonWithFrame:CGRectMake(70, 390-64, 180, 20) ImageName:@"" Target:self Action:@selector(permitClick) Title:@"我是大萌星软件许可及服务条款"];
